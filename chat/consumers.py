...
from chat.models import SingleChat, Messages, Profile, get_users_chat
...
class ChatConsumer(AsyncWebsocketConsumer):
    ...
    @database_sync_to_async
    def send_webpush_notifications(self, message):
        from_user = self.scope['user'].profile.name
        user = Profile.objects.get(id=self.chat_id).user
        payload = {'head': from_user, 'body': message['message'],
                   'icon': 'https://i.imgur.com/dRDxiCQ.png'} # 'url': 'https://www.youtube.com'
